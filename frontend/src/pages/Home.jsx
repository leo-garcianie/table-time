  ...
  return (
    <div className="min-h-full w-full flex flex-col items-center justify-center">
      <header className="flex flex-col text-center mt-12 text-dark items-center z-99">
        ...
        <h3 className="font-semibold text-7xl">Your Perfect Table</h3>
      ...
      <div className="flex gap-5 mt-12 z-999">
        <img src="/img1.svg" alt="Landing Img1" className="size-64 border-4 border-gray-100 rounded-4xl" />
        <img src="/img2.svg" alt="Landing Img2" className="size-64 border-4 border-gray-100 rounded-4xl" />
        <img src="/img3.svg" alt="Landing Img3" className="size-64 border-4 border-gray-100 rounded-4xl" />
      </div>
    </div>
  );
};
